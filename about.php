...
<html lang="en">
    ...
    <head>
        ...
        <meta name="description" content="锦麒行旅游官方网站">
        <!-- ======== Page title ============ -->
        <title>关于——锦麒行旅游</title>
        <!--<< Favcion >>-->
    ...
    <body>
        ...
        <div class="breadcrumb-wrapper section-padding bg-cover" style="background-image: url('assets/img/breadcrumb.jpg');">
            <div class="container">
                <div class="page-heading">
                    <h1 class="wow fadeInUp" data-wow-delay=".3s">关于</h1>
                    ...
                    <div class="service-card-items">
                        <div class="service-content">
                            ...
                            <div class="content">
                                <h4>01</h4>
                                <h3>
                                    <a href="service-details.html">专业的管家服务和会员代订服务，确保客户享受最佳价格和待遇。</a>
                                </h3>
                            </div>
                        </div>
                    ...
                    <div class="service-card-items">
                        <div class="service-content">
                            ...
                            <div class="content">
                                <h4>02</h4>
                                <h3>
                                    <a href="service-details.html">多渠道的预订方式，包括积分预定和优惠渠道预定。
                                    </a>
                                </h3>
                            </div>
                        </div>
                    ...
                    <div class="service-card-items">
                        <div class="service-content">
                            ...
                            <div class="content">
                                <h4>03</h4>
                                <h3>
                                    <a href="service-details.html">高效的客户服务和全方位的出行安排。
                                    </a>
                                </h3>
                            </div>
                        </div>
                    ...
                    <div class="service-card-items">
                        <div class="service-content">
                            ...
                            <div class="content">
                                <h4>04</h4>
                                <h3>
                                    <a href="service-details.html">与票务代理商的合作，提供独家内部渠道票务服务。
                                    </a>
                                </h3>
                            </div>
                        </div>
                    ...
                    <div class="service-card-items">
                        <div class="service-content">
                            ...
                            <div class="content">
                                <h4>05</h4>
                                <h3>
                                    <a href="service-details.html">利用互联网脚本自动搜集机票积分兑换信息，并通过服务器资源自动计算为人民币，提升服务效率。
                                    </a>
                                </h3>
                            </div>
                        </div>
                    ...
                    <div class="service-card-items">
                        <div class="service-content">
                            ...
                            <div class="content">
                                <h4>06</h4>
                                <h3>
                                    <a href="service-details.html">开设微信公众号，提供更便捷的服务和信息获取渠道。
                    ...
                    <div class="row">
                        <div class="col-lg-5">
                            <div class="service-counter-content">
                                ...
                                <a href="contact.html" class="theme-btn bg-white mt-4 wow fadeInUp" data-wow-delay=".7s">
                                    <span>
                                        联系我们
        ...
        <section class="team-section section-padding section-bg-3">
            <div class="container">
                <div class="section-title text-center">
                    <span class="wow fadeInUp">our hounrable team</span>
                    <h2 class="text-white wow fadeInUp" data-wow-delay=".3s">
                ...
                <div class="row align-items-center">
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".3s">
                        <div class="single-team-items style-2">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".7s">
                        <div class="single-team-items style-2">
                            ...
                            <div class="team-content text-center">
                                <h5>
                                    <a href="team-detaills.html">Shikhon David</a>
                                </h5>
                                <p>UI & UX DESIGNER</p>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".9s">
                        <div class="single-team-items style-2">
                            ...
                            <div class="team-content text-center">
                                <h5>
                                    <a href="team-detaills.html">Salman Ahmed</a>
                                </h5>
        ...
        <!--
        <div class="marque-section-2">
            <div class="container-fluid">
                <div class="marquee-wrapper text-slider style-height-2">
                    <div class="marquee-inner to-left">
                        <ul class="marqee-list d-flex">
                            <li class="marquee-item style-3">
                                <span class="text-slider"><img src="assets/img/asterisk-2.svg" alt="img"></span><span class="text-slider">Open Hours : Mon-Fri: 9 AM – 6 PM Saturday: 9 AM – 4 PM Sunday: Closed</span>
                                <span class="text-slider"><img src="assets/img/asterisk-2.svg" alt="img"></span><span class="text-slider">Germany —785 15h Street, Office 478Berlin, De 81566</span>
                                <span class="text-slider"><img src="assets/img/asterisk-2.svg" alt="img"></span><span class="text-slider">Get In Touch — phone: +1(800)123-4566</span>
                                <span class="text-slider"><img src="assets/img/asterisk-2.svg" alt="img"></span><span class="text-slider">Open Hours : Mon-Fri: 9 AM – 6 PM Saturday: 9 AM – 4 PM Sunday: Closed</span>
                                <span class="text-slider"><img src="assets/img/asterisk-2.svg" alt="img"></span><span class="text-slider">Germany —785 15h Street, Office 478Berlin, De 81566</span>
                                <span class="text-slider"><img src="assets/img/asterisk-2.svg" alt="img"></span><span class="text-slider">Get In Touch — phone: +1(800)123-4566</span>
                                <span class="text-slider"><img src="assets/img/asterisk-2.svg" alt="img"></span><span class="text-slider">Open Hours : Mon-Fri: 9 AM – 6 PM Saturday: 9 AM – 4 PM Sunday: Closed</span>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-11">
                                <div class="testimonial-items">
                                    <div class="testimonial-image bg-cover" style="background-image: url('assets/img/testimonial/07.png');"></div>
        ...
        <!--<< Brand Section Start >>-->
        <!--
        <div class="brand-section-3 fix section-padding pt-0">
            <div class="container">
            ...
            <div class="container">
                ...
                <div class="news-carousel-active">
                    <div class="news-card-items">
                        <div class="news-image bg-cover" style="background-image: url('assets/img/news/03.jpg');"></div>
