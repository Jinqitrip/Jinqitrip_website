                                ...
                                <div class="row g-4 mt-3">
                                    ...
                                    <div class="col-lg-6 wow fadeInUp" data-wow-delay=".9s">
                                        <div class="info-items">
                                            ...
                                            <div class="content">
                                                <h5>企业微信</h5>
                                                <a href="https://work.weixin.qq.com/ca/cawcded25274db25f6" style="color: #166FD3;text-decoration:underline ;">锦麒行旅游 </a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <form action="contact.php" id="contact-form" method="POST">
                                    <div class="row g-4">
                                        ...
                                        <div class="col-lg-6 wow fadeInUp" data-wow-delay=".8s">
                                            <button type="submit" class="theme-btn" onclick="window.alert('我们尚未取得收集用户信息资质，请使用其他方式联系我们。');">
